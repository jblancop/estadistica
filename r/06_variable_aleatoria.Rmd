...
Fx_gte0_lte1 = expression(2*x-x^2)
Deriv(Fx_gte0_lte1)
...
```{r}
E_X2 = (integrate(function(x) x^2 * (2-2*x), lower = 0, upper = 1)$value)

varianza = round((E_X2 - E^2) * 1000, 2)
varianza
```
